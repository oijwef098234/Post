...
public class CommentController {
    ...
    @PostMapping("/{id}")
    public ResponseEntity<String> createComment(@PathVariable Long postId, @RequestBody String comment){
        createComment.createComment(postId, comment);
    ...
    @GetMapping("/read-comment/{PostId}") // 댓글 id로 불러오기
    ...
    @GetMapping("/all/{postId}") // 게시글 전체 불러오기
